  ...
  return (
    <div className="sa-students">
                        ...
                        <div className={`sa-stu-more${menuId === id ? ' is-open' : ''}${i >= slice.length - 1 ? ' is-up' : ''}`}>
                          ...
                          {menuId === id && (
                            <div className="sa-stu-menu" role="menu" onClick={(e) => e.stopPropagation()}>
                              <button type="button" role="menuitem" onClick={() => { setActive(t, t.active === false); setMenuId(''); }}>
                                <i aria-hidden="true">
                                  {t.active === false ? (
                              ...
                              <button type="button" role="menuitem" className="is-danger" onClick={() => { setMenuId(''); remove(t); }}>
                                <i aria-hidden="true">
      ...
      {panel === 'form' && (
        ...
        <aside className="sa-action-modal sa-people-modal" aria-label={editingId ? 'Edit teacher' : 'Add teacher'} onClick={(e) => e.stopPropagation()}>
